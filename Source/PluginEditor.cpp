                                        ...
                                        juce::Slider& slider)
{
    ...
    g.setColour(Colour(97u, 12u, 126u)); 
...
void PathProducer::process(juce::Rectangle<float> fftBounds, double sampleRate)
{
   ...
   */
    ...
    /*
    bin width = sampleRate/FFTSize -- 48000/2048=23Hz
    */
    ...
    We only will display most recent path
    */
...
void ResponseCurveComponent::paint(juce::Graphics& g)
{
    ...
    auto& lowcut = monoChain.get<ChainPosistions::LowCut>();
    auto& peak = monoChain.get<ChainPosistions::Peak>();
    auto& highcut = monoChain.get<ChainPosistions::HighCut>();
    ...
    for (int i = 0; i < w; i++)
    {
        ...
        if (!monoChain.isBypassed < ChainPosistions::Peak>())
        {
...
void ResponseCurveComponent::resized()
{
    ...
    for (auto gDb : gains)
    {
        ...
        g.setColour(gDb == 0.f ? Colour(0u, 172, 1u) : Colours::darkgrey);
...
void SimpleEQAudioProcessorEditor::resized()
{
    ...
    bounds.removeFromTop(5); // little more space on top
